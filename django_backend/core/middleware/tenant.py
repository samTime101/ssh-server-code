...
class TenantMiddleware(MiddlewareMixin):
    def process_request(self, request):
        ...
        # If it is the root domain, set default/platform context
        ...
        try:
            # Query Client from Platform DB (default connection)
        ...
        # Dynamically register SQL Database connection if missing
        ...
        # Dynamically register MongoDB connection if missing
        ...
        if mongo_alias not in _connection_settings:
            ...
            # Strip database name from MONGO_URI to prevent it from overriding the custom tenant name
        ...
        # Apply to thread context variables
