...
const QuestionBankSection = () => {
  ...
  // Dummy data following the API response structure
        ...
        subCategories: [
          {
            ...
            subSubCategories: [
              ...
              { id: 3, name: "Rust Programming" },
              { id: 4, name: "JavaScript Programming" },
            ],
          },
          {
            id: 2,
            name: "DSA",
            subSubCategories: [
              { id: 5, name: "Arrays and Strings" },
              { id: 6, name: "Linked Lists" },
              { id: 7, name: "Trees and Graphs" },
            ],
          },
          {
            id: 3,
            name: "OOP",
            subSubCategories: [
              { id: 8, name: "Inheritance" },
              { id: 9, name: "Polymorphism" },
              { id: 10, name: "Encapsulation" },
            ],
          },
          {
            id: 4,
          ...
          },
          {
            ...
            subSubCategories: [
              { id: 13, name: "Frontend Development" },
              { id: 14, name: "Backend Development" },
        ...
        subCategories: [
          {
            ...
            name: "Calculus",
            subSubCategories: [
              { id: 16, name: "Differential Calculus" },
              { id: 17, name: "Integral Calculus" },
              { id: 18, name: "Multivariable Calculus" },
            ],
          },
          {
            id: 7,
            ...
            subSubCategories: [
              { id: 19, name: "Matrices" },
              { id: 20, name: "Vector Spaces" },
              { id: 21, name: "Eigenvalues" },
            ],
          },
          {
            id: 8,
            name: "Statistics",
            subSubCategories: [
              { id: 22, name: "Descriptive Statistics" },
              { id: 23, name: "Probability" },
              { id: 24, name: "Hypothesis Testing" },
            ],
          },
        ],
      },
        ...
        subCategories: [
          {
            ...
            subSubCategories: [
              { id: 25, name: "Kinematics" },
              { id: 26, name: "Dynamics" },
              { id: 27, name: "Energy and Momentum" },
            ],
          },
          {
            id: 10,
            name: "Thermodynamics",
            subSubCategories: [
              { id: 28, name: "Heat and Temperature" },
              { id: 29, name: "Laws of Thermodynamics" },
            ],
          },
        ],
      },
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <Button
            ...
            onClick={() => {
              console.log("Selected Categories IDs:", selectedCategoriesId);
