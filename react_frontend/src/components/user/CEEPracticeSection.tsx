  ...
  useEffect(() => {
    ...
    const getCategoriesData = async () => {
      try {
        ...
        if (!categoryResponse || !("categories" in categoryResponse)) {
  ...
  return (
    <section className="mx-auto flex min-h-full max-w-[1500px] flex-1 flex-col gap-8 p-8">
      <div className="border-border bg-card rounded-xl border p-6 shadow-sm">
        <h1 className="text-foreground mb-6 text-3xl font-bold">CEE Practice</h1>
          ...
          <div className="mt-4 flex justify-end">
            <label className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => setReattemptWrongOnly(checked === true)}
              />
