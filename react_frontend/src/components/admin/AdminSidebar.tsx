          ...
          {items.map((item) => {
            ...
            return (
              <Link
                ...
                onClick={onNavClick}
                className={cn(
                  "flex items-center gap-3 rounded-lg border border-transparent px-4 py-2.5 text-sm transition-all duration-200",
                  isActive
                    ? "bg-sidebar-primary text-sidebar-primary-foreground shadow-md"
                    : "text-sidebar-foreground hover:bg-sidebar-accent hover:shadow-sm"
                )}
        ...
        >
          {isCollapsed ? (
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className="text-destructive hover:border-destructive/20 hover:bg-destructive/10 flex w-full items-center justify-center rounded-lg border border-transparent px-2 py-3 transition-all duration-200 hover:shadow-sm"
                  >
            ...
            <>
              ...
              <button
                onClick={() => setShowLogoutModal(true)}
                className="text-destructive hover:border-destructive/20 hover:bg-destructive/10 flex w-full items-center gap-4 rounded-lg border border-transparent px-4 py-3 transition-all duration-200 hover:shadow-sm"
              >
                <LogOut size={18} className="text-destructive" />
          ...
          {isCollapsed ? (
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  ...
                  className={cn(navButtonClass(false, true), "w-full")}
            ...
            <button
              onClick={onToggleCollapse}
              className={cn(navButtonClass(false, false), "w-full")}
